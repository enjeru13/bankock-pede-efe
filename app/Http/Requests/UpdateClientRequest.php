...
/**
 * Form Request para validar la actualización de un cliente.
 * 
 * Define las reglas de validación para actualizar un cliente existente.
 * Similar a StoreClientRequest pero el código debe ser único excepto
...
class UpdateClientRequest extends FormRequest
{
    ...
    {
        return true; // Todos los usuarios autenticados pueden actualizar clientes
    }
    ...
    {
        // Obtener el ID del cliente que se está actualizando
        ...
        return [
            ...
            // Código único del cliente (obligatorio y único excepto para este cliente)
            'code' => [
                'required',
                'string',
                'max:50',
